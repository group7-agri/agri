...
class Profile(models.Model):
    ...
    phone = PhoneField(blank=True, unique=True, null=True, help_text='Must be unique (startwith  +250)')
    otherPhone = PhoneField(blank=True, null=True, help_text='Start with Country Code(eg:  +250)')
