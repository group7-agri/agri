"""
Django settings for ayieldsearch project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.43.119','172.31.121.10','agri-production.up.railway.app', 'agri-portal.com/']
...
# AWS_STORAGE_BUCKET_NAME = 'ayieldsearch-bucket'
